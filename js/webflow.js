...
Webflow.require('ix').init([
  {"slug":"new-interaction","name":"New Interaction","value":{"style":{"x":"0px","y":"0px"},"triggers":[{"type":"hover","stepsA":[{"transition":"transform 500ms ease 0ms","x":"5px","y":"0px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}},
  {"slug":"new-interaction-up","name":"New Interaction up","value":{"style":{"x":"0px","y":"0px"},"triggers":[{"type":"hover","stepsA":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"-2px"}],"stepsB":[{"transition":"transform 500ms ease 0ms","x":"0px","y":"0px"}]}]}}
]);
